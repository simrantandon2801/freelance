...
<Grid container lg={12} xs={12} >
  ...
  <Typography sx={{textAlign:'Left',fontSize:'28px',color:'#1F2937'}}>Devops & Site Realibility Engineering</Typography>
</Grid>
</Grid>
<Grid container lg={10} xs={11} sx={{marginBottom:"30px",margin:'auto'}} >
<Grid item lg={10} xs={10} sx={{margin:'auto',marginLeft:'0px'}} >
  <Typography sx={{textAlign:'left',fontSize:'18px',marginTop:'20px',color:'#737373'}}>Codalent Devops team can help you with all your Devops needs.We can help you with:</Typography>
</Grid>
</Grid>
...
<Grid container spacing={2} lg={10.8}  sx={{margin:'auto'}}>	
            ...
            <Grid container spacing={2} lg={10.8} sx={{margin:'auto'}}>	
					...
					<Grid item lg={11}>
					  <Typography >Containers/Orchestrain</Typography>
            ...
            <Grid container spacing={2} lg={10.8} sx={{margin:'auto'}}>	
					...
					<Grid item lg={11} xs={10}>
					  <Typography >Monitoring and Performance</Typography>
...
<Grid item lg={10} sx={{margin:'auto',marginLeft:'0px'}} >
  <Typography sx={{textAlign:'left',fontSize:'18px',marginTop:'20px',color:'#737373'}}>FASTEST GROWING ORGANIZATION TRUST US</Typography>
              ...
              <Paper sx={{width:mobile?'100% ':'448px',height:mobile?'700px':'654px',position:'absolute',left:mobile?'0px':"800px",top:mobile?'570px':"150px",borderRadius:'8px',border:"1px solid #E5E7EB"}}>

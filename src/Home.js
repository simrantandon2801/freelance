...
<Grid item lg={10} xs={10} sx={{margin:'auto',marginLeft:'0px'}} >
  <Typography sx={{textAlign:'left',fontSize:'18px',marginTop:'20px',color:'#737373'}}>Get an experienced team of frontend developers for your next project.</Typography>
</Grid>
</Grid>
...
<Grid container spacing={2} lg={10.8}  sx={{margin:'auto'}}>	
            ...
            <Grid container spacing={2} lg={10.8} sx={{margin:'auto'}}>	
					...
					<Grid item lg={11}>
					  <Typography >Best practices and standards</Typography>
            ...
            <Grid container spacing={2} lg={10.8} sx={{margin:'auto'}}>	
					...
					<Grid item lg={11} xs={10}>
					  <Typography > Modern Technologies: React,GatsBy,Next.js & Svelte </Typography>
...
<Grid item lg={10} sx={{margin:'auto',marginLeft:'0px'}} >
  <Typography sx={{textAlign:'left',fontSize:'18px',marginTop:'20px',color:'#737373'}}>FASTEST GROWING ORGANIZATION TRUST US</Typography>
              ...
              <Paper sx={{width:mobile?'100% ':'448px',height:mobile?'700px':'654px',position:'absolute',left:mobile?'0px':"800px",top:mobile?'550px':"150px",borderRadius:'8px',border:"1px solid #E5E7EB"}}>
